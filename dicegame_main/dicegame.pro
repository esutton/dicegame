...
# Make all warnings into errors - without "-Werror" warnings are useless as they do not demand to be fixed.
QMAKE_CFLAGS += "-Werror"
QMAKE_CFLAGS += "-Wall"
QMAKE_CFLAGS += "-Wextra"
...
OTHER_FILES += build.sh \
    ../build.sh \
    ../dicegame/doc/DiceGame.doxyfile \
    ../dicegame/doc/src/pageTest.dox \
    ../dicegame/doc/src/pageMain.dox \
    ../dicegame/doc/src/pageCodeCoverage.dox \
    ../dicegame/index.html \
    ../dicegame/doc/src/pageConfigurationFile.dox \
    dicegame.config
